import { Chemical, Color, Formula, Ingredient, OvenType, Piece, Record, RecordPoint, Target, TargetPoint } from "./GQLResTypes";
...
type TargetFilter = PageFilter & QueryFilter<"id", number> & QueryFilter<"name", string> & QueryFilter<"oven", OvenType>;
...
type FormulaComposedFields = IngredientQuery | PieceQuery | TargetQuery;
...
export type ChemicalQuery = ComposedQueryField<"chemical" | "chemicals", ChemicalFields, ChemicalFilter>;
