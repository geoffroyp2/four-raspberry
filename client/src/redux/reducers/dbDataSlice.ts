...
export const { loadAllData } = dbDataSlice.actions;

export const dbDataRecord = (state: RootState) => state.dbDataReducer.record;
export const dbDataReference = (state: RootState) => state.dbDataReducer.reference;
export const dbDataPiece = (state: RootState) => state.dbDataReducer.piece;
export const dbDataFormula = (state: RootState) => state.dbDataReducer.formula;
export const dbDataChemical = (state: RootState) => state.dbDataReducer.chemical;
